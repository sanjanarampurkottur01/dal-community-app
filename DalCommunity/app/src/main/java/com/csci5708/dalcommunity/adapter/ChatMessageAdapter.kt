...
class ChatMessageAdapter(private var chats:ArrayList<ChatMessage>, private var context: Context):
    ArrayAdapter<ChatMessage>(context, 0,chats){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(
                if (messageObj?.sentById == "abc@gmail.com") R.layout.message_right_item else R.layout.message_left_item,
                parent,
                false
            )
        }
